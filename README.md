...
신규 기능을 개발할 때 일정을 준수하면서도 확장 가능하고 유지보수에 용이한 구조를 제안하고 구현합니다. 기능 개발 이후 고도화할 부분들을 메모해두고, 놓치지 않고 개선해나갑니다. 바쁜 일정 속에서도 디자인과 기능을 동시에 신경 쓰기 위해 노력하며, UI/UX를 개선하는 데 적극적으로 참여합니다.

개발 과정에서 내가 작성한 코드나 구현한 화면 등을 팀과 공유하며 성취감을 느낍니다. 개발 트렌드, 컨퍼런스 정보, 소소한 팁 등을 공유하며 지식을 전파하고 팀 전체의 성장에 기여합니다.

Nuxt.js 및 SvelteKit을 활용하여 **다양한 서비스를 구축하고 운영한 경험**이 있습니다. 특히 SvelteKit 개발을 선호하며, 빠르고 효율적인 개발 프로세스를 경험하였습니다.

웹뷰로 제공하던 서비스의 UI 컴포넌트를 웹 기반으로 이전하는 작업을 성공적으로 수행한 경험이 있습니다. 이를 통해 앱의 의존도를 줄이는 데 성공하여 **웹에서도 서비스 제공**이 가능하게 되었습니다.
